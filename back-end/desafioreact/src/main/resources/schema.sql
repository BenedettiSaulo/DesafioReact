...
CREATE TABLE IF NOT EXISTS `desafioreact`.`tb_user` (
  ...
  `cd_permissionlevel` INT NOT NULL COMMENT 'Código do nível de permissão do usuário - fk da tb_permissionlevel',
  `tx_image` VARCHAR(255) NULL COMMENT 'Caminho da imagem',
  PRIMARY KEY (`id_user`),
